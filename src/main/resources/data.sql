insert into course(id, name, created_date, last_update_date) values(10001, 'JPA in 50 Steps', sysdate(), sysdate());
insert into course(id, name, created_date, last_update_date) values(10002, 'Spring in 50 Steps', sysdate(), sysdate());
insert into course(id, name, created_date, last_update_date) values(10003, 'Spring Boot in 100 Steps', sysdate(), sysdate());

--Insert Passaport first - will be associated in Student
insert into passport(id, number) values(40001, 'E123456');
insert into passport(id, number) values(40002, 'N12357');
